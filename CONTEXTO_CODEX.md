...
- Em 2026-09-08, adicionada a aba Combustivel com indicadores e lista mensal de abastecimentos; Simulacao passou a ser a penultima aba.
- Em 2026-09-08, atualizada a copia local com a `main` remota (rotina mensal e simulacao). Corrigido o salvamento da rotina de trabalho: dias habituais, trabalho em feriados e excecoes do calendario agora persistem automaticamente, com recalculo dos dias planejados ao mudar feriados.
